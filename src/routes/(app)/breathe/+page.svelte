...
<div class="w-full relative flex flex-col items-center">
	<span class="h-[200px] relative flex justify-center items-center ">
		<p class="anim-circle mt-14">diaphragmatic animation sadkfisdaf</p>
	</span>
	<div class="h-32 w-80 relative">
		{#key instruction}
			<div
				class="absolute inset-0 mt-10 font-serif text-2xl flex justify-center text-center"
				transition:fade|local={{ duration: 3000 }}
			>
				{instruction}
			</div>
		{/key}
