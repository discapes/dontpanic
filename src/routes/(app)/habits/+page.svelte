...
<svelte:head>
	...
	<style>
		body {
			background: rgba(228, 206, 185) !important;
...
<div class="habits flex justify-center">
	<div class="max-w-lg">
		...
		<h5>
			...
			the best possible way in everyday life and what you can do yourself to cope even better. You
			can influence your own well-being with very simple, daily things. This section allows you to
			look at your own everyday life. What things could you change in your everyday life?
		</h5>
		...
		<p>
			...
			<br />You don't have to reach the level of elite sports. Regularity is important in exercise:
			at least half an hour of exercise every day or longer a few times a week. Functional exercise
			is also counted as exercise. So you don't necessarily have to go to the gym or dance classes.
			For example, a brisk walk home from work is already exercise. Regular exercise also
			facilitates sleep. Are you moving enough? Would you like to increase the share of exercise in
			everyday life? If you don't have enough time, think about whether you could combine exercise
			and everyday routines. Could you walk part of your commute, manage social relationships while
			moving or go to the store on foot.
		</p>
		...
		<p>
			...
			major role in mood.
			<br />A regular eating rhythm also sets the rhythm of the day. You should eat five times a
			day.
			<br />When you eat, focus on eating and enjoy it in peace. When you eat regularly, you keep
			your blood sugar balance, your state of alertness and your stamina steady throughout the day.
			Rarely have treat days.
			<br />In addition to eating, it is important to drink enough fluids. An adult should drink
			about 1 ½ to 2 liters of water a day.
		</p>

		<h2>Social relationships</h2>

		<p>
			Take care of your social relationships. The presence or contact of another person is
			important. Talking about things, working together or just being present reduces stress. Which
			people are important to you? Are you keeping in touch with them enough? Even one friend is
			precious. My family and relatives are important networks.
			<br />Do you miss new relationships? Establishing new social relationships can seem
			challenging at first. However, it is important to bravely go out and look at the surroundings.
			You can find new friends through studying or work. It is possible to meet people interested in
			the same things in hobbies, communities or clubs.
		</p>

		<h2>Sleep and relaxation</h2>

		<p>
			A person's natural need for sleep varies from individual to individual. A healthy adult needs
			an average of seven to eight hours of sleep per day. Good quality sleep is important for a
			person, because sleep is connected to a person's psychological and physical resources.
			...
			Prolonged insomnia causes irritability and mood swings. Insomnia also weakens concentration
			and memory and makes learning difficult.
			...
			sleep and your need for sleep in balance? Below is a list of ways you can improve your
			sleeping habits:
			<br />
		</p>
		<ul>
			...
			<li>
				If you wake up in the middle of your sleep and can't get back to sleep right away, get up
				and do something calming
			</li>
		</ul>
	</div>
</div>
